...
def start_rosbag_recording():
    ...
    rosbag_process = subprocess.Popen(['rosbag', 'record', '/rosout', '-O', 'S1W3_3.bag'])
...
def set_waypoints():
    ...
    waypoints = [
        {'x': 3.0, 'y': -4.0, 'w': 1.0, 'seq': 1},
        {'x': 2.5, 'y': -6.5, 'w': -1.0, 'seq': 2},
        {'x': 2.0, 'y': -11.0, 'w': -1.0, 'seq': 3},
        # {'x': -3.0, 'y': -6.0, 'w': 1.0, 'seq': 4},
        # {'x': 2.0, 'y': -4.0, 'w': 1.0, 'seq': 5}    
    ]
