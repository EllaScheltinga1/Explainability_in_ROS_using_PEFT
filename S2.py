...
def start_rosbag_recording():
    ...
    rosbag_process = subprocess.Popen(['rosbag', 'record', '/rosout', '-O', 'S2W3_test.bag'])
...
def set_waypoints():
    ...
    waypoints = [
        {'x': 1.0, 'y': -2.0, 'w': 1.0, 'seq': 1},
        {'x': 1.5, 'y': -8.0, 'w': 1.0, 'seq': 2},
        {'x': -3.0, 'y': -8.5, 'w': 1.0, 'seq': 3},
        # {'x': -3.0, 'y': -9.0, 'w': 1.0, 'seq': 4},
        # {'x': -4.0, 'y': -9.5, 'w': 1.0, 'seq': 5} 
    ]
