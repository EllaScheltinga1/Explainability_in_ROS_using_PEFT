...
def start_rosbag_recording():
    ...
    rosbag_process = subprocess.Popen(['rosbag', 'record', '/rosout', '-O', 'S3W5_3.bag'])
...
def set_waypoints():
    ...
    waypoints = [
        {'x': -2.0, 'y': 0.0, 'w': 1.0, 'seq': 1},
        {'x': 2.5, 'y': -5.5, 'w': 1.0, 'seq': 2},
        {'x': 1.0, 'y': -10.0, 'w': 1.0, 'seq': 3},
        {'x': -3.5, 'y': -10.5, 'w': 1.0, 'seq': 4},
        {'x': 4.0, 'y': -8.0, 'w': 1.0, 'seq': 5} 
    ]
