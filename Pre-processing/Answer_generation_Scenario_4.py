...
client = OpenAI(api_key='sk-proj-wckZD7qJSFUfAiXygnwlT3BlbkFJl810KHPo7hJ5lRtDXbs2')

# Path to your CSV file
folder_path = 'Scenario_4/Processed_csv/'
...
for filename in os.listdir(folder_path):
    if filename.endswith(".csv"):
        ...
        output_file_path_1 = os.path.join("Scenario_4/Answers_Q1", output_file_name_q1)
        ...
        output_file_path_2 = os.path.join("Scenario_4/Answers_Q2", output_file_name_q2)
        ...
        output_file_path_3 = os.path.join("Scenario_4/Answers_Q3", output_file_name_q3)
        ...
        output_file_path_4 = os.path.join("Scenario_4/Answers_Q4", output_file_name_q4)
        ...
        output_file_path_5 = os.path.join("Scenario_4/Answers_Q5", output_file_name_q5)
        ...
        output_file_path_6 = os.path.join("Scenario_4/Answers_Q6", output_file_name_q6)
        ...
        output_file_path_7 = os.path.join("Scenario_4/Answers_Q7", output_file_name_q7)
        ...
        output_file_path_8 = os.path.join("Scenario_4/Answers_Q8", output_file_name_q8)
        
        # Write the response to the output text file
        with open(output_file_path_8, 'w', encoding='utf-8') as output_file:
            output_file.write(responses["q8"])
        
        print(f"The response has been saved to {output_file_path_8}")

        ######## Q9 ########
        # Create the output file name
        file_base_name = os.path.splitext(filename)[0]
        output_file_name_q9 = f"{file_base_name}_Q9a.txt"
        output_file_path_9 = os.path.join("Scenario_4/Answers_Q9", output_file_name_q9)
        ...
        output_file_path_10 = os.path.join("Scenario_4/Answers_Q10", output_file_name_q10)
        ...
        # Create the output file name
        file_base_name = os.path.splitext(filename)[0]
        output_file_name_q11 = f"{file_base_name}_Q11a.txt"
        output_file_path_11 = os.path.join("Scenario_4/Answers_Q11", output_file_name_q11)
        
        # Write the response to the output text file
        with open(output_file_path_11, 'w', encoding='utf-8') as output_file:
            output_file.write(responses["q11"])
    
        print(f"The response has been saved to {output_file_path_11}")

        ######## Q12 ########
        # Create the output file name
        file_base_name = os.path.splitext(filename)[0]
        output_file_name_q12 = f"{file_base_name}_Q12a.txt"
        output_file_path_12 = os.path.join("Scenario_4/Answers_Q12", output_file_name_q12)
        
        # Write the response to the output text file
        with open(output_file_path_12, 'w', encoding='utf-8') as output_file:
            output_file.write(responses["q12"])
    
        print(f"The response has been saved to {output_file_path_12}")

        ######## Q13 ########
        # Create the output file name
        file_base_name = os.path.splitext(filename)[0]
        output_file_name_q13 = f"{file_base_name}_Q13a.txt"
        output_file_path_13 = os.path.join("Scenario_4/Answers_Q13", output_file_name_q13)
        ...
        output_file_path_14 = os.path.join("Scenario_4/Answers_Q14", output_file_name_q14)
