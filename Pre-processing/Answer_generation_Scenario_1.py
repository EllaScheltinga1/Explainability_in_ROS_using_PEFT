...
folder_path = 'Scenario_1/Processed_csv/'
...
for filename in os.listdir(folder_path):
    if filename.endswith(".csv"):
        ...
        output_file_path_1 = os.path.join("Scenario_1/Answers_Q1", output_file_name_q1)
        ...
        output_file_path_2 = os.path.join("Scenario_1/Answers_Q2", output_file_name_q2)
        ...
        output_file_path_3 = os.path.join("Scenario_1/Answers_Q3", output_file_name_q3)
        ...
        output_file_path_4 = os.path.join("Scenario_1/Answers_Q4", output_file_name_q4)
        ...
        output_file_path_5 = os.path.join("Scenario_1/Answers_Q5", output_file_name_q5)
        ...
        output_file_path_6 = os.path.join("Scenario_1/Answers_Q6", output_file_name_q6)
        ...
        output_file_path_7 = os.path.join("Scenario_1/Answers_Q7", output_file_name_q7)
        ...
        output_file_path_8 = os.path.join("Scenario_1/Answers_Q8", output_file_name_q8)
        ...
        output_file_path_9 = os.path.join("Scenario_1/Answers_Q9", output_file_name_q9)
        ...
        output_file_path_10 = os.path.join("Scenario_1/Answers_Q10", output_file_name_q10)
